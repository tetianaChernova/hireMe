                            ...
                            <tr>
                                <td align="center">
                                    <div style="line-height: 44px;">
                                        <span style="font-size: 34px; font-family: Arial, Helvetica, sans-serif; font-size: large; color: #57697e; ">
                                            <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">${text}</span>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
                                        <span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
                                            2021 © HireMe. ALL Rights Reserved.
                                        </span>
                                </td>
                            </tr>
                        </table>
